...
const TOURISM_CATEGORIES_API_URL = `${API_ENDPOINT_CN}/api/v1/tourism-categories`;
const TOURISM_DETAIL_API_URL = (slug) => `${API_ENDPOINT_CN}/api/v1/tourism-categories/${slug}`;
