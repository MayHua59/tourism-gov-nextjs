...
const UPCOMING_EVENTS_API_URL = `${API_ENDPOINT_KR}/api/v1/upcoming-events`;
const UPCOMING_EVENTS_DETAIL_API_URL = (slug) => `${API_ENDPOINT_KR}/api/v1/upcoming-events/${slug}`;
