    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Festivales", href: "/es/festivals", active: true }
        ]}
      />
      <div className={styles.container}>
        ...
        {loading ? (
          ...
          <div className={styles.errorMessage}>
            Konnte keine Festival-Daten laden. Bitte versuchen Sie es erneut.
          </div>
        ) : (
          <>
            <div className={styles.festivalList}>
              {festivals.map(festival => (
                <Link
                  ...
                  href={`/de/festivals/${festival.slug || festival.id}`}
