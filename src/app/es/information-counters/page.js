...
export const metadata = {
  title: "Informationsschalter (Information Counters)",
  description: "Informationen über die Informationsschalter des Ministeriums für Hotels und Tourismus, Myanmar."
};
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Mostradores de Información", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>Informationsschalter</h1>
          <p className={styles.paragraph}>Informationen über die Informationsschalter des Ministeriums für Hotels und Tourismus, Myanmar.</p>
