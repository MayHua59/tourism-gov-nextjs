...
export const metadata = {
  ...
  description: "Myanmar Visa On Arrival information"
};
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Visa a la Llegada", active: true }
        ]}
      />
        ...
        <section id="visa-on-arrival-content" className={styles.mt5}>
          <div className={styles.visaInfoSection}>
            ...
            <p className={styles.paragraph}>
              Japanese, Republic of Korea, Macau (Special Administrative Region of the People’s Republic of China) Nationals will be granted Visa On Arrival from October 21, 2024 for a test period of 1 year.
            </p>
