...
import styles from "@/app/en/why-invest-in-myanmar/WhyInvest.module.css";
import { faHome } from "@fortawesome/free-solid-svg-icons";

export const metadata = {
  title: "미얀마 투자하는 이유",
  description: "미얀마 투자하는 이유에 대한 정보입니다."
};
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "미얀마 투자하는 이유", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>미얀마 투자하는 이유</h1>
