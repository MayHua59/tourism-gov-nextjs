    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Zweigstelleninformationen", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>Zweigstelleninformationen (Branch Offices Contact Information)</h1>
        <p className={styles.paragraph}>Informationen über die Zweigstellen des Ministeriums für Hotels und Tourismus, Myanmar.</p>
