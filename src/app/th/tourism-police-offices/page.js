...
export const metadata = {
  title: "สำนักงานการท่องเที่ยว (Tourism Police Offices)",
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>สำนักงานการท่องเที่ยว และสำนักงานการท่องเที่ยวต่างๆ</h1>
        <p>เมียนมาร์ สำนักงานการท่องเที่ยวจะมีสำนักงานการท่องเที่ยวที่ตั้งในเมียนมาร์</p>
