...
export const metadata = {
  title: "비자 면제",
  description: "러시아 연방 관광객이 미얀마에 방문할 때 비자 면제에 대한 정보입니다."
};
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "비자 면제", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>비자 면제</h1>
        <section id="visa-exemption-content" className={styles.mt5}>
          <div className={styles.businessSection}>
            ...
            <p className={styles.paragraph}>
              러시아 연방 관광객이 보통 여권을 보유한 경우, 2022년 7월 1일부터 비자 면제가 부여됩니다.
            </p>
          </div>
          <div className={styles.businessSection}>
