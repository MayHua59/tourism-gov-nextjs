...
import styles from "@/app/en/investment-opportunity/InvestmentOpportunity.module.css";
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "관광 투자 기회", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>관광 투자 기회</h1>

        <section id="tourism-investment-content" className={styles.mt5}>
          <div className={styles.investSection}>
            <h2>미얀마의 관광 및 호텔 투자 기회를 포착하세요</h2>
            <p>
            ...
            <h3>호텔, 모텔, 인/게스트하우스의 가용 용량 분포 (FY 2016-2017)</h3>
            <div className={styles.tableResponsive}>
              <table className={styles.investTable}>
                <thead>
                  <tr>
                    <th>주 / 지역</th>
                    <th>호텔, 모텔, 인/게스트하우스 수</th>
                    <th>방 수</th>
                  </tr>
                </thead>
                <tbody>
