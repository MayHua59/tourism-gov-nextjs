    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "การติดต่อ", active: true }
        ]}
      />
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>สำนักงานการท่องเที่ยวของรัฐมนตรีคงคลาด (Contact Us)</h1>

        <section id="contact-info">
          <p>
            สำนักงานการท่องเที่ยวของรัฐมนตรีคงคลาดจะมีการท่องเที่ยวสำนักงานการท่องเที่ยวของรัฐมนตรีคงคลาด
          </p>
