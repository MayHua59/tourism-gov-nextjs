  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.container}>
        <h1 className={styles.pageTitle}>สำนักงานการท่องเที่ยว (Information Counters)</h1>
          <p className={styles.paragraph}>เมียนมาร์ สำนักงานการท่องเที่ยวจะมีสำนักงานการท่องเที่ยวที่ตั้งในเมียนมาร์</p>
