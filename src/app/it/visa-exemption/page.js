...
import styles from "@/app/en/visa-exemption/VisaExemption.module.css";
import { faHome } from "@fortawesome/free-solid-svg-icons";

export const metadata = {
  title: "Visa Exemption",
  description: "Russian Federation tourists visiting Myanmar will be granted visa exemption."
};
    ...
    <div className={styles.pageContainer}>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "Esenzione dal Visto", active: true }
        ]}
      />
        ...
        <section id="visa-exemption-content" className={styles.mt5}>
          <div className={styles.businessSection}>
            ...
            <p className={styles.paragraph}>
              If a Russian Federation tourist holds an ordinary passport, visa exemption will be granted from July 1, 2022.
            </p>
          </div>
          <div className={styles.businessSection}>
