        ...
        <div className="row mb-0">
          <div className="col-lg-4 col-sm-6 mb-4">
            <div className={styles.footerWidget}>
              <h3 className={styles.widgetTitle}>Быстрые ссылки</h3>
              
              <ul>
                <li><Link href="/ru/information-pages/about-myanmar">Исследовать Мьянму</Link></li>
                <li><Link href="/ru/maps">Карта</Link></li>
                <li><Link href="/ru/tourism-publication">Публикации по туризму</Link></li>
                <li><Link href="/ru/brochures-and-pamphlets">Брошюры и брошюры</Link></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6 mb-4">
            <div className={styles.footerWidget}>
              <h3 className={styles.widgetTitle}>Исследуйте наш сайт</h3>
              
              <ul>
                <li><Link href="/ru/news">Новости</Link></li>
                <li><Link href="/ru/announcements">Объявления</Link></li>
                <li><Link href="/ru/hotels-and-resorts">Размещение</Link></li>
                <li><Link href="/ru/festivals">Праздники</Link></li>
              </ul>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6 mb-4">
            <div className={styles.footerWidget}>
              <h3 className={styles.widgetTitle}>Свяжитесь с нами</h3>
