...
const digitalServices = [
  ...
  // },
  {
    ...
    icon: <FaChartLine />,
    title: "Sistema de Pago de Turismo",
    description:
      "Tu enlace directo para gestionar convenientemente y de forma segura todos los pagos para servicios de turismo.",
  },
  {
    href: "https://hotel.myanmar.gov.mm/",
    icon: <FaHotel />,
    title: "Sistema de Información de Lista de Invitados",
    description:
      "Este servicio digital facilita la gestión y accesibilidad de todos los detalles de los invitados a tu evento.",
  },
  {
    href: "https://2020election.uec.gov.mm/",
    image: "/assets/images/uec-image.jpg",
    title: "Fraudes y Malpracticas Electorales",
    description:
      "Hallazgos de la Investigación de Fraudes y Malpracticas en las Elecciones Generales de 2020 de la Democracia Multipartidista",
  },
];
        ...
        <div className="row justify-content-center">
          <div className="col-lg-7 text-center">
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>Servicios Digitales del Ministerio</h2>
              <span className={styles.titleBorder}></span>
              <p>
                Accede a nuestras plataformas en línea y servicios digitales para negocios de turismo y viajeros
                negocios y viajeros
              </p>
            </div>
          </div>
