...
const truncateDescription = (description, maxLength) => {
  ...
  return (
    <section className={styles.latestNewsSection}>
      <div className="container py-5">
        <h2 className="text-center mb-5" style={{ fontSize: "2rem" }}>Últimas Noticias</h2>
        {loading && (
  ...
  ></p>
                    <Link href={`/es/news/${news.slug}`} className={readMore}>
                      Leer Más
                    </Link>
                  </div>
                </div>
        ...
        <div className="text-center mt-4">
          <Link href="/es/news" className="btn btn-outline-primary rounded-0">
