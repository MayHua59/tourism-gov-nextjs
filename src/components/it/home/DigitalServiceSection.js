...
const digitalServices = [
  ...
  // },
  {
    ...
    icon: <FaChartLine />,
    title: "Sistema di Pagamento del Turismo",
    description:
      "Il vostro collegamento diretto per gestire comodamente e in sicurezza tutti i pagamenti per i servizi turistici.",
  },
  {
    href: "https://hotel.myanmar.gov.mm/",
    icon: <FaHotel />,
    title: "Sistema Informativo Lista Ospiti",
    description:
      "Questo servizio digitale semplifica la gestione e l'accessibilità di tutti gli ospiti dei vostri eventi.",
  },
  {
    href: "https://2020election.uec.gov.mm/",
    image: "/assets/images/uec-image.jpg",
    title: "Frodi Elettorali e Irregolarità",
    description:
      "Risultati dell'indagine su frodi elettorali e irregolarità nelle elezioni parlamentari della democrazia multipartitica in Myanmar nel 2020",
  },
];
        ...
        <div className="row justify-content-center">
          <div className="col-lg-7 text-center">
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>Servizi Digitali del Ministero</h2>
              <span className={styles.titleBorder}></span>
              <p>
                Accesso alle nostre piattaforme online e servizi digitali per aziende turistiche e viaggiatori
              </p>
            </div>
          </div>
        </div>
