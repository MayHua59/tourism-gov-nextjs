        ...
        <div className={styles.picturesHeaderRow}>
          <div className={styles.picturesHeaderCol}>
            <div className={styles.picturesSectionHeader}>
              <h2 className={styles.picturesSectionTitle}>Myanmar in Immagini</h2>
              <span className={styles.picturesTitleBorder}></span>
              <p>
                Scoprite la bellezza e la diversità del Myanmar attraverso la nostra galleria fotografica, che mostra
                punti di riferimento iconici e tesori nascosti.
              </p>
            </div>
          </div>
        </div>
