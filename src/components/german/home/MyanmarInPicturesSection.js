...
const galleryItems = [
  ...
  },
  {
    ...
    title: "Ngapali am Sonnenuntergang",
        ...
        <div className={styles.picturesHeaderRow}>
          <div className={styles.picturesHeaderCol}>
            <div className={styles.picturesSectionHeader}>
              ...
              <p>
                Entdecken Sie die Schönheit und Vielfalt von Myanmar durch unsere Foto-Galerie, die ikonische
                Landmarken und versteckte Schätze zeigt.
              </p>
            </div>
          </div>
        </div>
