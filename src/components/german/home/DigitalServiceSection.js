...
const digitalServices = [
  ...
  // },
  {
    ...
    icon: <FaChartLine />,
    title: "Tourismuszahlungssystem",
    description:
      "Ihr direkter Link zum bequem und sicher alle Zahlungen für Tourismusdienstleistungen verwalten.",
  },
  {
    href: "https://hotel.myanmar.gov.mm/",
    icon: <FaHotel />,
    title: "Gästeliste Informationssystem",
    description:
      "Dieses digitale Service vereinfacht die Verwaltung und Zugänglichkeit aller Ihrer Veranstaltungsgäste.",
  },
  {
    href: "https://2020election.uec.gov.mm/",
    image: "/assets/images/uec-image.jpg",
    title: "Wahlfälschungen und Unregelmäßigkeiten",
    description:
      "Erkenntnisse zur Untersuchung von Wahlbetrug und Missständen bei den Parlamentswahlen der Mehrparteien-Demokratie in Myanmar im Jahr 2020",
  },
];
        ...
        <div className="row justify-content-center">
          <div className="col-lg-7 text-center">
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>Ministerium Digital Services</h2>
              <span className={styles.titleBorder}></span>
              <p>
                Zugang zu unseren Online-Plattformen und digitalen Diensten für Tourismusunternehmen und Reisende
              </p>
            </div>
          </div>
        </div>
